...
app.post('/api/croupier', express.json(), async (req,res)=>{
  ...
  const apiKey = process.env.ANTHROPIC_API_KEY || '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';
...
- Never break character`,
    ...
    if(!data.content) console.error('Anthropic error:', JSON.stringify(data));
    res.json({reply: reply||data.error?.message||'Viktor šiuo metu nepasiekiamas.'});
  } catch(e) {
