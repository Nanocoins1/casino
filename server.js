...
app.post('/api/croupier', express.json(), async (req,res)=>{
  ...
  const apiKey = process.env.ANTHROPIC_API_KEY || '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';
