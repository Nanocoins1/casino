...
app.post('/api/croupier', express.json(), async (req,res)=>{
  ...
  const apiKey = process.env.ANTHROPIC_API_KEY || 'sk-ant-api03-n_VfB0fQ53wqey2e1AQv_1Z4dgYD60ddkH0FlEJn0P0SwqLkcU7nFxLdzF58ugcFkK1BJ9pC06jgAws7d_na3Q-h11P0gAA';
